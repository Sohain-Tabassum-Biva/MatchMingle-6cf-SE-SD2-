    ...
    <div class="content" id="content">
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <?php
                $successStories = [
                    ["How Ayesha and Rahul Found Love on MatchMingle", "May 01, 2025", "Ayesha and Rahul’s journey is a testament to the power of connection.", "They met through a mutual interest in literature and bonded over long conversations. After months of dating, they tied the knot in a beautiful ceremony surrounded by family.", "images/couple1.jpg"],
                    ["From Online Chat to a Lifetime Together: Priya & Arjun", "April 15, 2025", "Priya and Arjun met through MatchMingle and are now happily married.", "Their first chat turned into daily conversations, and within a year, they were engaged. Their wedding was a blend of both their cultures, filled with joy.", "images/couple2.jpg"],
                    ["Sara and Ahmed’s Interfaith Love Story", "April 14, 2025", "An inspiring tale of love bridging cultural gaps.", "Sara and Ahmed navigated their interfaith relationship with grace, celebrating both their traditions in a unique wedding ceremony.", "images/couple3.jpg"],
                    ["Zainab and Omar’s Dream Wedding", "April 13, 2025", "A couple who found their soulmate with MatchMingle’s help.", "Their wedding was a dream come true, with a traditional Nikah followed by a vibrant Walima celebration.", "images/couple4.jpg"],
                    ["Neha and Vikram’s Journey to Happiness", "April 12, 2025", "A story of perseverance and love.", "Despite initial challenges, Neha and Vikram’s commitment to each other led to a joyful marriage filled with love.", "images/couple5.jpg"],
                    ["Fatima and Hassan’s Match Made Online", "April 11, 2025", "How a simple search led to a lifetime commitment.", "Fatima’s search for a partner with shared values brought her to Hassan, and they’ve been inseparable since.", "images/couple6.jpg"],
                    ["Riya and Karan’s Modern Romance", "April 10, 2025", "A contemporary love story born on MatchMingle.", "Riya and Karan’s modern approach to love led to a trendy wedding with a minimalist theme.", "images/couple7.jpg"],
                    ["Amina and Yusuf’s Cultural Blend", "April 09, 2025", "A beautiful union of two rich traditions.", "Amina and Yusuf blended their cultural backgrounds in a wedding that honored both their heritages.", "images/couple8.jpg"],
                    ["Priyanka and Rohan’s Fairytale Ending", "April 08, 2025", "A match that turned into a lifelong partnership.", "Priyanka and Rohan’s story is like a fairytale, with a magical wedding that felt straight out of a storybook.", "images/couple9.jpg"],
                    ["Hina and Asif’s Long-Distance Love", "April 07, 2025", "Overcoming distance to find true love.", "Hina and Asif’s long-distance relationship thrived through constant communication, leading to a heartfelt reunion and marriage.", "images/couple10.jpg"],
                    ["Meera and Sameer’s Quick Connection", "April 06, 2025", "A fast friendship that blossomed into marriage.", "Meera and Sameer clicked instantly, and within months, they were planning their future together.", "images/couple11.jpg"],
                    ["Salma and Ibrahim’s Shared Faith", "April 05, 2025", "A bond strengthened by common values.", "Salma and Ibrahim’s shared faith and values made their marriage a natural and blessed union.", "images/couple12.jpg"],
                    ["Anjali and Arjun’s Family Approval", "April 04, 2025", "A match supported by both families.", "With the blessings of both families, Anjali and Arjun’s wedding was a celebration of unity and love.", "images/couple13.jpg"],
                    ["Nadia and Tariq’s Adventure Begins", "April 03, 2025", "A couple ready to explore life together.", "Nadia and Tariq’s love for adventure brought them together, and their wedding marked the start of a new journey.", "images/couple14.jpg"],
                    ["Sneha and Vikram’s Second Chance", "April 02, 2025", "Love found again through MatchMingle.", "After previous heartbreaks, Sneha and Vikram found a second chance at love and happiness.", "images/couple15.jpg"],
                    ["Zara and Ali’s Serendipitous Meeting", "April 01, 2025", "A chance encounter that led to forever.", "Zara and Ali’s unexpected connection on MatchMingle turned into a lifelong commitment.", "images/couple16.jpg"],
                    ["Kavita and Raj’s Traditional Match", "March 31, 2025", "A classic arranged marriage with a modern twist.", "Kavita and Raj’s traditional match was enhanced by modern communication, leading to a perfect union.", "images/couple17.jpg"],
                    ["Layla and Hassan’s Joyful Union", "March 30, 2025", "A celebration of love and commitment.", "Layla and Hassan’s wedding was filled with joy, music, and the love of their families.", "images/couple18.jpg"],
                    ["Deepika and Amit’s Shared Dreams", "March 29, 2025", "A couple with aligned life goals.", "Deepika and Amit’s shared vision for the future made their marriage a strong partnership.", "images/couple19.jpg"],
                    ["Sana and Omar’s Digital Romance", "March 28, 2025", "Love that started with a click.", "Sana and Omar’s online chats turned into a deep connection, culminating in a beautiful wedding.", "images/couple20.jpg"],
                    ["Rina and Sanjay’s Cultural Fusion", "March 27, 2025", "A blend of traditions in a modern marriage.", "Rina and Sanjay’s wedding was a fusion of their cultural traditions, creating a unique celebration.", "images/couple21.jpg"],
                    ["Aisha and Faisal’s Faith Journey", "March 26, 2025", "A spiritual connection that grew stronger.", "Aisha and Faisal’s shared faith journey led to a marriage filled with spiritual harmony.", "images/couple22.jpg"],
                    ["Tara and Vikrant’s Mutual Respect", "March 25, 2025", "A relationship built on understanding.", "Tara and Vikrant’s mutual respect and understanding laid the foundation for a lasting marriage.", "images/couple23.jpg"],
                    ["Huma and Zaid’s Family Ties", "March 24, 2025", "Love supported by a strong family network.", "Huma and Zaid’s families played a key role in their union, making their wedding a family affair.", "images/couple24.jpg"],
                    ["Shalini and Rohit’s Shared Humor", "March 23, 2025", "A couple bonded by laughter.", "Shalini and Rohit’s shared sense of humor brought them closer, leading to a joyful marriage.", "images/couple25.jpg"],
                    ["Nazia and Imran’s Long Courtship", "March 22, 2025", "A slow build to a lasting relationship.", "Nazia and Imran took their time to build a strong foundation, resulting in a beautiful marriage.", "images/couple26.jpg"],
                    ["Pooja and Anil’s Dream Home", "March 21, 2025", "A match that led to a shared future.", "Pooja and Anil’s shared dream of building a home together came true after their wedding.", "images/couple27.jpg"],
                    ["Fatima and Ahmed’s Travel Love", "March 20, 2025", "A couple united by their love for adventure.", "Fatima and Ahmed’s love for travel brought them together, and their wedding was a new adventure.", "images/couple28.jpg"],
                    ["Kiran and Ravi’s Quiet Love", "March 19, 2025", "A subtle connection that turned into marriage.", "Kiran and Ravi’s quiet and steady love led to a peaceful and happy marriage.", "images/couple29.jpg"],
                    ["Zoya and Hamza’s Perfect Match", "March 18, 2025", "A story of compatibility and love.", "Zoya and Hamza’s perfect compatibility made their marriage a match made in heaven.", "images/couple30.jpg"]
                ];
